...
var blobServiceClient = BlobServiceClient.fromConnectionString(env_1.default.AZURE_STORAGE_CONNECTION_STRING);
var containerClient = blobServiceClient.getContainerClient(env_1.default.AZURE_STORAGE_CONTAINER_NAME);
var containerUrl = "".concat(env_1.default.AZURE_STORAGE_CONNECTION_STRING, "/").concat(env_1.default.AZURE_STORAGE_CONTAINER_NAME);
function getImages() {
    return __awaiter(this, void 0, void 0, function () {
        var images, _a, _b, _c, blob, tempBlockBlobClient, image, e_1_1;
        var _d, e_1, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 12: return [2 /*return*/, images];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, blockBlobClient.uploadFile(image.filepath)];
                case 1:
...
function deleteImage(imageId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    blockBlobClient = containerClient.getBlockBlobClient(imageId);
