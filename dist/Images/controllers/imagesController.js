...
var ImagesController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, (0, imagesService_1.getImages)()];
                    case 1:
                        images = _a.sent();
    ...
    ImagesController.prototype.uploadImage = function (imageFile, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, imagesService_1.uploadImage)(imageFile)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
    ...
    ImagesController.prototype.deleteImage = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var imageId, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, imagesService_1.deleteImage)(imageId)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        error_3 = _a.sent();
                        return [4 /*yield*/, this.errorLoggerService.logError(error_3)];
                    case 3:
                        _a.sent();
                        res.status(500).json({ error: 'Internal server error' });
                        return [3 /*break*/, 4];
